    ...
    <div class="page-content">
        ...
        <div class="invoice-content-2 bordered">
                ...
                <div class="col-xs-12 table-responsive">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <tr>
                                <td class="text-center sbold">
                                    {{ $order->address->addressProvince->governorate->name_ar }} <br>
                                </td>
                                <td class="text-center sbold">
                                    {{ $order->address->addressProvince->name_ar }} <br>
                                </td>
                                <td class="text-center sbold">
                                    {{ $order->address->block }}
                                </td>
            ...
            <div class="row invoice-body">
                ...
                <div class="col-xs-12 table-responsive">
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                <th class="invoice-title uppercase text-center">موعد الاستلام</th>
            ...
            <div class="row invoice-subtotal">
                <div class="col-xs-3">
                    <h2 class="invoice-title uppercase">المجموع</h2>
                    <p class="invoice-desc">{{ Price($order->subtotal) }} KD</p>
                </div>
                <div class="col-xs-3">
                    <h2 class="invoice-title uppercase">التوصيل </h2>
                    <p class="invoice-desc">{{ Price($order->shipping) }} KD</p>
                </div>
                <div class="col-xs-3">
