                    ...
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group">
                                        <a href="{{ url(route('models.create')) }}" class="btn sbold green">
                                            <i class="fa fa-plus"></i> اضافة موديل جديد
                                        </a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <table class="table table-striped table-bordered table-hover table-checkable">
                                <thead>
                                    <tr role="row" class="heading">
                                        ...
                                        <th width="15%"> بحث بالعلامة التجارية</th>
                                    </tr>
                            ...
                            <div class="portlet-body">
                                <div class="table-container">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group">
                                            <button type="submit" id="deleteChecked" class="btn red btn-sm" onclick="deleteAllChecked('{{ url(route('models.deletes')) }}')">
                                            تطبيق
                                            </button>
                                        </div>
                                    </div>
