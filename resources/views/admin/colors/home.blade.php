...
@section('title','جميع الالوان المتاحة')
@section('content')
                    ...
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group">
                                        <a href="{{ url(route('colors.create')) }}" class="btn sbold green">
                                            <i class="fa fa-plus"></i> اضافة لون جديد
                                        </a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="portlet-body">
                                <div class="table-container">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group">
                                            <button type="submit" id="deleteChecked" class="btn red btn-sm" onclick="deleteAllChecked('{{ url(route('colors.deletes')) }}')">
                                            تطبيق
                                            </button>
                                        </div>
                                    </div>
