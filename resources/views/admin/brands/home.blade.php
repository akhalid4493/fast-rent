...
@section('title','جميع العلامات التجارية')
@section('content')
    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="#">جميع العلامات التجارية</a>
                </li>
            </ul>
        </div>
                    ...
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group">
                                        <a href="{{ url(route('brands.create')) }}" class="btn sbold green">
                                            <i class="fa fa-plus"></i> اضافة علامة تجارية جديدة
                                        </a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="portlet-body">
                                <div class="table-container">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group">
                                            <button type="submit" id="deleteChecked" class="btn red btn-sm" onclick="deleteAllChecked('{{ url(route('brands.deletes')) }}')">
                                            تطبيق
                                            </button>
                                        </div>
                                    </div>
