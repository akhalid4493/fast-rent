...
class EditStoreRequest extends FormRequest
{
    ...
    {
        return [
            'name_ar'     => 'required|unique:stores,name_ar,'.$this->route('store'),
            'name_en'     => 'required|unique:stores,name_en,'.$this->route('store'),
            'type'        => 'required',
            'user_id'     => 'required|unique:stores,user_id,'.$this->route('store'),
            'status'      => 'required',
